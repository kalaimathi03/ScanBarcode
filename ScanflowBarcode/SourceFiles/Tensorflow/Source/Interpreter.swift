...
public final class Interpreter {
  ...
  public var inputTensorCount: Int {
    ...
    /**
     The total number of outpu `Tensor`s associated with the model.
     */
  ...
  public func input(at index: Int) throws -> Tensor {
    ...
    /**
     ...
     - Parameters:
        - index: The local file path to a TensorFlow Lite model.
        - Throws: An error if the index is invalid, tensors haven't been allocated, or interpreter has not been invoked for models that dynamically compute output tensors based on the values of its input tensors.
        - Returns: The output `Tensor` at the given index.
     */
  ...
  public func resizeInput(at index: Int, to shape: Tensor.Shape) throws {
    ...
    /**
     ...
     - Parameters:
        ...
        - index: The index for the input `Tensor`.
        - Throws: `An error if the `data.count` does not match the input tensor's `data.count` or if the given index is invalid.
